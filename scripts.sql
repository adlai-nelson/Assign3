...
-- Due to the large number of data fields, there were only 8 properies inpu
...
ORDER BY PropertyID;
-- Insert PropertyID and Utility into PropertyZoning table
...
-- Find properties within 2km of Clark University (Coordinates: 42.251389 -71.8241867)
SELECT Address, City
FROM PropertyDetails
WHERE ST_DWithin(
